...
<head>
    ...
    <title>CF Order - บริการคอนเฟิร์มออเดอร์สินค้าผ่านไลน์ ใครๆก็ทำได้</title>
    <meta name="description" content="บริการคอนเฟิร์มออเดอร์สินค้าและเว็บไซต์สำเร็จรูป">
                    ...
                    <div class="heading-wrapper">
                        <div class="col-lg-6 col-lg-offset-6 text-white text-right">
                            ...
                            <p class="">ลูกค้าเยอะ ตอบไลน์ไม่ทัน โอ๊ยลืมอีกว่าลูกค้าจะสั่งอะไร ขอเปิดเว็บดูก่อนนะ
                                ...
                                <br>
                                บริการคอนเฟิร์มออเดอร์ออนไลน์ @cforder</p>
                        </div>
                    </div>
                </div>
                <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <table class="package table table-responsive">
                    ...
                    <tbody>
                    <tr>
                        <td class="text-left" rowspan="2">Line @cforder</td>
                    ...
                    <tr>
                        <td class="text-left lc-lp-spec-black"  rowspan="3">ฟังก์ชันต่างๆ ของ  @cforder</td>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 text-center">
                    ...
                    <br/> <br/>
                    <a href="#" class="bottom-menu-brand">Powered by cf-order.com</a>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12  text-center">
                    <ul class="bottom-menu-iconic-list">
                        <br/>
                        <i class="fa fa-phone-square" aria-hidden="true"></i> Contact : support@cf-order.com
                    </ul>
                </div>
            </div>
        </div>
