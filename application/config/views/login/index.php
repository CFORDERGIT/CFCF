<head>
    ...
    <title>CF Order | เข้าสู่ระบบ</title>
    <!-- Bootstrap Core CSS -->
    ...
    <div class="lg-info-panel">
        <div class="inner-panel">
            ...
            <div class="lg-content">
                <h2>CF Order - คอนเฟิร์มออเดอร์</h2>
                <p class="text-muted">บริการคอนเฟิร์มออเดอร์ผ่าน LINE BOT ง่ายต่อการขายของออนไลน์ สะดวกต่อนักขายมืออาชีพ</p>
