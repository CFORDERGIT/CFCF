...
//            }
            ...
            //$this->lineapi->pushmsg($data["uid"], "ขอบคุณที่อุดหนุนค่ะ ลูกค้าสามารถติดตามการสั่งซื้อได้ที่ลิงค์นี้ http://cf-order.com/track/$token");
//            $v_merchantuid = $this->get->v_merchantuid(array('ordertoken' => $token))->result();
//            foreach ($v_merchantuid as $item) {
//                $this->lineapi->pushmsg($item->lineuid, "ลูกค้าได้ส่งคำสั่งการสั่งซื้อ สามารถดูได้ที่ http://cf-order.com/track/$token/$item->lineuid");
//            }

            $this->lineapi->pushmsg($data["uid"], "ลูกค้าได้ส่งคำสั่งการสั่งซื้อ สามารถดูได้ที่ http://cf-order.com/track/$token/" . $data["uid"]);
...
<div  jstcache=\"0\" width=\"100%\" style=\"background: #f8f8f8; padding: 0px 0px; font-family:arial; line-height:28px; height:100%;  width: 100%; color: #514d6a;\">
  <div  jstcache=\"0\" style=\"padding:50px 0;  margin: 0px auto; font-size: 14px\">
        ...
        <tbody  jstcache=\"0\">
          <tr  jstcache=\"0\">
            <td  jstcache=\"0\" ><b>Dear  $txtfullname,</b>
              <p   jstcache=\"0\" >ขอบคุณที่อุดหนุนสินค้าที่ร้านเรา ลูกค้าสามารถติดตามสถานะสินค้าได้ที่ <br/><a href=\"http://cf-order.com/track/$billtoken\" style=\"background-color: #fb4;letter-spacing: .05em;
    border-radius: 60px;
    padding: 4px 12px 3px;
    font-weight: 500;text-decoration: none;color: #fff\">http://cf-order.com/track/$billtoken</a></p>
    ...
    <div  jstcache=\"0\" style=\"text-align: center; font-size: 12px; color: #b2b2b5; margin-top: 20px\">
      <p  jstcache=\"0\"> Powered by cf-order.com <br>
        <a href=\"http://cf-order.com/\" style=\"color: #b2b2b5; text-decoration: underline;\">สนใจเปิดร้านค้า</a> </p>
    </div>
  </div>
</div>
</body>
