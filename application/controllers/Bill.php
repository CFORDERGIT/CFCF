...

{
...

    {
        ...
        $linetoken = 'btm08QKW3iFQQKmcGGU8Q6KADTGo4OaT7q3GRKMP9yX';
...

    {
        ...
        $data = [
            ...
            'replyToken' => "770dbdd7e08addda4cfbd1287cb553f3",
...
//                    ];
...

    {
        ...
        $uid = "U96f31711092e0befcad8f3fecb0ee84c";
...
//        $event['source']['userId'] = "U96f31711092e0befcad8f3fecb0ee84c";
                    ...
                    case "ค้นหา":
                        ...
                        if (count($orderhistory) > 0) {
                            ...
                            foreach ($orderhistory as $index => $item) {
                                ...
                                $msg .= "$no. https://cf-order.com/$item->token \n    $paidtime\n";
                        ...
                        foreach ($merchants as $item) {
                            ...
                            for ($i = count($billcolums); $i < 3; $i++) {
                                ...
                                array_push($billcolums, array("type" => "message",
                                    ...
                                    "text" => "สามารถสร้างบิลเพิ่มได้ที่ https://cf-order.com/account/$item->token/dashboard"));
                        ...
                        array_push($colums, array(
                            ...
                            'actions' => array(
                                ...
                                array(
                                    ...
                                    "uri" => "https://cf-order.com/pro/$item->token/$uid"
            ...
            if (count($msgqarr) >= 2) {
                ...
                switch ($command) {
                    ...
                    case "บิล":
                        ...
                        $replymsg = "ลูกค้าสามารถซื้อสินค้าได้ที่ลิงค์นี้ https://cf-order.com/$merchant->token";
...

    {
        ...
        if ($msg[0] == "getbilltoken") {
            ...
            if ($data["sqlmerchant"]->num_rows() > 0) {
                ...
                return $messages = [
                    ...
                    'text' => "https://cf-order.com/$billtoken"
        ...
        if ($msg[0] == "getbilltokennogen") {
            ...
            return $messages = [
                ...
                'text' => "https://cf-order.com/$billtoken->token"
