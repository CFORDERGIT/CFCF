...
class Service extends CI_Controller
{
    ...
    public function getpromobill()
    {
        ...
        $this->lineapi->pushmsg($merchantuid, "บิลสำหรับลูกค้าของคุณ http://cf-order.com/$order[1]");
...
//            $html .= "</td>";
    ...
    public function confirmpayment()
    {
        ...
        //$this->lineapi->pushmsg($ordertoken->uid, "สถานะของคุณถูกเปลี่ยนแล้ว http://cf-order.com/track/$ordertoken->token");
        $this->output->set_header('Content-Type: application/json; charset=utf-8');
        echo json_encode($data);
    }
