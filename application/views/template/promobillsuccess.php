...
<head>
    ...
    <meta name="description" content="บริการคอนเฟิร์มออเดอร์จาก <?= $merchant->name ?> ปลอดภัย สะดวก รวดเร็ว">
    ...
    <div class="row" style="margin-top:50px;">
        <div class="col-xs-12 text-center">
            ...
            <small>คุณสามารถนำลิงค์นี้ไปให้ลูกค้าสั่งซื้อได้เลย<br/> <span id="animationlink" class="text-danger"
                                                                           style="display: inline-block;">cf-order.com/<b><?= $ordertoken->token ?></b></span>
...
<div class="mtl pbl">
    <div class="bottom-menu">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <a href="#fakelink" class="bottom-menu-brand">Powered by cf-order.com</a>
                </div>
